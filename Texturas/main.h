...
char **generate_maze(int **maze, int start_row, int start_col, int **visited, int matrix_dim) {
                ...
                if (visited[row][col] == 0) { 
                    ...
                    if (start_row == row && start_col != col) {
                        if (start_col > col) {
                            ...
                            maze_plan[temp_row][temp_col-1] = '0';
                            maze_plan[temp_row][temp_col-2] = '0';
                            temp_col -= 2;
                        ...
                        if (start_row > row) {
                            ...
                            maze_plan[temp_row-1][temp_col] = '0';
                            maze_plan[temp_row-2][temp_col] = '0';
                            temp_row -= 2;
                        } else {
                            temp_col1 = temp_col;
                            temp_row1 = temp_row;
